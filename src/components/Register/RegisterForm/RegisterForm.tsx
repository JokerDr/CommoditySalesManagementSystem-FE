...
import { Input, Checkbox, Button, Icon, Select, Col, Tooltip, Cascader, Row } from 'antd';
...
@observer
class Register<T extends RegisterFormModel> extends ComponentExt<T, IUserFormProps> {
    state = {
        confirmDirty: false,
      };
      handleSubmit = (e: any) => {
...
export default Form.create<IUserFormProps>({})(Register);
