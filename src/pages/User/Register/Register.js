...
import { Form, Input, Button, message, Row, Col, Popover, Progress } from 'antd';
          ...
          <FormItem>
            {getFieldDecorator('name', {
              rules: [
                ...
                {
                  type: 'email',
                  message: formatMessage({ id: 'validation.name.wrong-format' }),
                },
              ],
          ...
          <FormItem>
            {getFieldDecorator('address', {
              rules: [
                ...
                {
                  type: 'email',
                  message: formatMessage({ id: 'validation.address.wrong-format' }),
                },
              ],
            })(
