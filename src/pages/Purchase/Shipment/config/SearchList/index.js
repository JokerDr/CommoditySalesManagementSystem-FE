...
class SearchList extends PureComponent {
  handleFormReset = () => {
    ...
    // 重置状态
    dispatch({
      type: 'purchaseShipment/handleSearchList',
      payload: {
        expandForm: false,
        formValues: {},
      },
  ...
  toggleForm = () => {
    const { purchaseShipment, dispatch } = this.props;
    dispatch({
      type: 'purchaseShipment/handleSearchList',
      payload: {
        expandForm: !purchaseShipment.searchList.expandForm,
      },
    });
  };
  ...
  renderButtonGroups() {
    ...
    const { expandForm } = purchaseShipment.searchList;
    return (
